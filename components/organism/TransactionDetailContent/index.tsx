          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Your Game ID" value="mayo" />
                <Row label="Order ID" value="#GG001" />
                <Row label="Item" value="250 Diamonds" />
                <Row label="Price" value={420000} />
                <Row label="Tax (10%)" value={4220} />
                <Row label="Total" value={42312323} isTotal />
              </div>
              <div className="payment pt-10 pb-10">
                <h2 className="fw-bold text-xl color-palette-1 mb-20">
                  Payment Informations
                </h2>
                <Row label="Your Account Name" value="Tb Rivan" />
                <Row label="Type" value="WorldWide Transfer" />
                <Row label="Bank Name" value="Mandiri" />
                <Row label="Bank Account Name" value="PT RV" />
                <Row label="Bank Number" value="1800-323-212" />
              </div>
